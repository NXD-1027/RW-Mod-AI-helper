...
# 4. VS Code → 扩展 → ⋯ → 从 VSIX 安装 → 选择生成的 .vsix 文件
```
...
本项目的绝大部分代码、文档和功能设计由 AI 生成。从项目初始化、功能实现、Bug 修复、国际化适配到文档撰写，AI 贯穿了开发的各个环节。
